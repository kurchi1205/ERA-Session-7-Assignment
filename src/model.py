...
class Model_2(nn.Module):
    def __init__(self):
        ...
        # OUTPUT BLOCK
        self.convblock7 = nn.Sequential(
            nn.Conv2d(in_channels=30, out_channels=20, kernel_size=(1, 1), padding=0, bias=False),
            nn.BatchNorm2d(20),
            nn.ReLU(),
            nn.Dropout(0.1)
        ) # output_size = 7 >>> 25
        ...
        self.out = nn.Conv2d(in_channels=20, out_channels=10, kernel_size=(1, 1), padding=0, bias=False)
...
class Model_3(nn.Module):
    def __init__(self):
        ...
        self.pool1 = nn.MaxPool2d(2, 2) # output_size = 11. # rin = 5 rout = 6
